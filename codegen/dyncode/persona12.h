...
class Persona12 : public Atomic {
  public:
    
    Persona12(const string &name = "persona12" );
    virtual string className() const {  return "persona12" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[12] = {S, S, S, S, S, S, S, S, S, S, S, S};
