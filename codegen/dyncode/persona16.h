...
class Persona16 : public Atomic {
  public:
    
    Persona16(const string &name = "persona16" );
    virtual string className() const {  return "persona16" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[16] = {S, S, S, S, S, S, S, S, S, S, S, S, S, S, S, S};
