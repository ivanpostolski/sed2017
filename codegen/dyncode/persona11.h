...
class Persona11 : public Atomic {
  public:
    
    Persona11(const string &name = "persona11" );
    virtual string className() const {  return "persona11" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[11] = {S, S, S, S, S, S, S, S, S, S, S};
