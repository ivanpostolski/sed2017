...
class Persona13 : public Atomic {
  public:
    
    Persona13(const string &name = "persona13" );
    virtual string className() const {  return "persona13" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[13] = {S, S, S, S, S, S, S, S, S, S, S, S, S};
