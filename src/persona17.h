...
class Persona17 : public Atomic {
  public:
    
    Persona17(const string &name = "persona17" );
    virtual string className() const {  return "persona17" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[17] = {S, S, S, S, S, S, S, S, S, S, S, S, S, S, S, S, S};
