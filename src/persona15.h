...
class Persona15 : public Atomic {
  public:
    
    Persona15(const string &name = "persona15" );
    virtual string className() const {  return "persona15" ;}
  ...
  private:
    ...
    Estado estadoActual; 
    Estado vecinos[15] = {S, S, S, S, S, S, S, S, S, S, S, S, S, S, S};
