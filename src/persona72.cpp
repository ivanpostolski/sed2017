...
Persona72::Persona72(const string &name) :
Atomic(name),
name(name),
...
in64(addInputPort("in64")),
out64(addOutputPort("out64")), 
in65(addInputPort("in65")),
out65(addOutputPort("out65")), 
in66(addInputPort("in66")),
out66(addOutputPort("out66")), 
in67(addInputPort("in67")),
out67(addOutputPort("out67")), 
in68(addInputPort("in68")),
out68(addOutputPort("out68")), 
in69(addInputPort("in69")),
out69(addOutputPort("out69")), 
in70(addInputPort("in70")),
out70(addOutputPort("out70")), 
in71(addInputPort("in71")),
out71(addOutputPort("out71")),
nvecinos(72),
recuperado(false),
estadoActual(S),
gen(this->rd())
{
	 ...
	 vecinos2port[64] = &out64;
	 vecinos2port[65] = &out65;
	 vecinos2port[66] = &out66;
	 vecinos2port[67] = &out67;
	 vecinos2port[68] = &out68;
	 vecinos2port[69] = &out69;
	 vecinos2port[70] = &out70;
	 vecinos2port[71] = &out71;
}


Model &Persona72::initFunction()
{
...
int Persona72::infectados(Estado vecinos[]){
	int result = 0;
...
int Persona72::susceptibles(Estado vecinos[]){
	int result = 0;
	for(int i = 0; i < nvecinos;i++){
		if (vecinos[i]==S){
			result++;
...
void Persona72::setearRelojDeInfeccion(){
...
void Persona72::setearRelojDeVacunacion(){
...
Model &Persona72::externalFunction(const ExternalMessage &msg)
{
...
Model &Persona72::internalFunction(const InternalMessage &)
{
	...
	Model &Persona72::outputFunction(const CollectMessage &msg)
	{
